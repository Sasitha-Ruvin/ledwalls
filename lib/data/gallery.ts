...
export const StageStockPortfolio: PortfolioImage[] = [
  {
    ...
    alt: "Indoor stage rental for hotel ballroom and conference Sri Lanka by YC Events",
    category: "stage",
  },
  {
...
export const LedWallPortfolioIntro = {
  ...
  title: "Recent LED screen rentals across Sri Lanka",
  description:
...
export const ServicesPagePortfolioIntro = {
  ...
  description:
    "LED wall rentals, stage builds and digital podiums from real YC Events bookings. Filter by event type or browse the full gallery.",
};

export const GalleryPageMeta = {
  title: "Gallery | LED Wall Rental Portfolio Sri Lanka",
  description:
    "YC Events gallery: LED wall rental, stage and truss builds, and digital podiums across Sri Lanka. Weddings, concerts, corporate events and award ceremonies.",
  keywords: [
    "LED wall rental gallery Sri Lanka",
...
export const GalleryPageIntro = {
  ...
  imageAlt:
    "LED wall rental concert stage Sri Lanka outdoor IP65 screen by YC Events",
};
