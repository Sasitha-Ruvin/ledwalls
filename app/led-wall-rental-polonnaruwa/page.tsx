...
export default function LedWallRentalPolonnaruwaPage() {
  const city = getLedWallCityBySlug(CITY_SLUG);
  if (!city) notFound();

  return (
    <>
      <JsonLd data={buildLedWallCitySchema(city)} id="json-ld-led-wall-polonnaruwa" />
